...
const Header = () => {
  return (
    <div className='w-screen bg-black z-50 fixed flex md:justify-end justify-between h-[10vh] items-center'>
      ...
      <a href='' className='z-50'><button className='z-50 mx-6 text-black md:text-[1.1vw] md:w-auto font-[balle] bg-red-600 rounded-xl' > <span className='text-transparent'>&gt;</span> Coming Soon.. <span className='text-transparent'>&gt;</span> </button></a>
    </div>
  )
}
